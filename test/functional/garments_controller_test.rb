...
class GarmentsControllerTest < ActionController::TestCase
  ...
  test "should create garment" do
    assert_difference('Garment.count') do
      post :create, garment: { code: @garment.code, gender: @garment.gender, name: @garment.name, reference: @garment.reference }
    end
  ...
  test "should update garment" do
    put :update, id: @garment, garment: { code: @garment.code, gender: @garment.gender, name: @garment.name, reference: @garment.reference }
    assert_redirected_to garment_path(assigns(:garment))
  end
