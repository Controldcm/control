...
class InputsControllerTest < ActionController::TestCase
  ...
  test "should create input" do
    assert_difference('Input.count') do
      post :create, input: { description: @input.description, meter_cost: @input.meter_cost, name: @input.name, total_cost: @input.total_cost, unit_cost: @input.unit_cost }
    end
  ...
  test "should update input" do
    put :update, id: @input, input: { description: @input.description, meter_cost: @input.meter_cost, name: @input.name, total_cost: @input.total_cost, unit_cost: @input.unit_cost }
    assert_redirected_to input_path(assigns(:input))
  end
