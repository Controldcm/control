...
class ProductionOrdersControllerTest < ActionController::TestCase
  ...
  test "should create production_order" do
    assert_difference('ProductionOrder.count') do
      post :create, production_order: { cliente_id: @production_order.cliente_id, garment_id: @production_order.garment_id, op: @production_order.op, programed_amount: @production_order.programed_amount, programing_date: @production_order.programing_date }
    end
  ...
  test "should update production_order" do
    put :update, id: @production_order, production_order: { cliente_id: @production_order.cliente_id, garment_id: @production_order.garment_id, op: @production_order.op, programed_amount: @production_order.programed_amount, programing_date: @production_order.programing_date }
    assert_redirected_to production_order_path(assigns(:production_order))
  end
